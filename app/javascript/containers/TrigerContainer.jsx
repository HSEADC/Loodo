...
export default class TrigerContainer extends PureComponent {
  ...
  initInstruments = () => {
    ...
    const melodySynthNode1 = new Tone.Synth(melodySynthSettings).toDestination()
    const melodySynthNode2 = new Tone.Synth(melodySynthSettings).toDestination()
  ...
  render() {
    ...
    return (
      <div className="SynthContainer">
        {webAudioStarted === true ? 'First' : 'Second'}
      </div>
    )
  }
}
